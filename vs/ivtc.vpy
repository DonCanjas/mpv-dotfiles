...
def IVTC(clip: vs.VideoNode, TFF: Optional[bool] = None) -> vs.VideoNode:
    """"
        Experimental script for inverse telecining and deinterlacing made by LightArrowsEXE <https://github.com/LightArrowsEXE/dotfiles/blob/master/mpv/.config/mpv/vs/ivtc.vpy>
